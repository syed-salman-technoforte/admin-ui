 ...
 private String newTestName = "";
  ...
  public void bulkUploadCRUD(String table) throws Exception {
   ...
   // Commons.click(test,driver,By.id("fileInput"));
    ...
    String filePath = System.getProperty("user.dir") + System.getProperty("path.config")+ "\\BulkUploadFiles\\"+ JsonUtil.JsonObjParsing(Commons.getTestData(),"loginlang")+"\\"+table+".csv";
